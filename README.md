...
I chose a monorepo structure to keep the frontend and backend codebases close together. This makes it easier to share domain knowledge, test end-to-end flows, and evolve the domain **(Company → Project → Claim)** consistently. Both apps are isolated (their own **package.json**) but versioned and managed in a single repository.
